  ...
  return (
    <section className="mt-12 pt-8 border-t border-gray-100 dark:border-gray-800">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {posts.map((post) => (
          <Link key={post.slug} href={href(`/posts/${post.slug}/`)} prefetch={false} className="group block p-4 rounded-lg border border-gray-100 dark:border-gray-800 hover:border-blue-200 dark:hover:border-blue-900 hover:bg-gray-50 dark:hover:bg-gray-900/50 transition-all">
